        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              autoComplete="email"
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-copper-500 focus:outline-none focus:ring-1 focus:ring-copper-500"
            />
            {errors.email && (
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-md bg-copper-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-copper-600 focus:outline-none focus:ring-2 focus:ring-copper-400 disabled:opacity-50"
          >
